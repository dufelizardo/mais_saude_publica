...
/**
 * Prontuário — agregação de leitura sobre Atendimento/Consulta/Procedimento de um Paciente (ver
 * ADR-0039 decisão 6, ADR-0045). Sem POST/PATCH: não existe entidade própria para criar/atualizar.
 */
@RestController
...
public class ProntuarioController {
    ...
    @Operation(summary = "Busca o prontuário consolidado de um paciente",
            description = "Agrega os Atendimentos do paciente, cada um com suas Consultas, cada uma com seus Procedimentos.",
            tags = "Prontuário")
