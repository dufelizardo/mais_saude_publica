...
public interface RegistroPontoRepository extends JpaRepository<RegistroPonto, UUID> {
    ...
    List<RegistroPonto> findByProfissional_MatriculaAndDataHoraBetweenOrderByDataHoraDesc(
            String matricula, LocalDateTime dataHoraInicio, LocalDateTime dataHoraFim);
}
