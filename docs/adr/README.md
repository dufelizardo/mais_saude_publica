...
| [0055](./0055-primeira-implementacao-de-login-usuario-jwt-e-toggle-por-ambiente.md) | Primeira implementação de login: `Usuario`, JWT e toggle por ambiente | Aceita e implementada (parte backend) |
